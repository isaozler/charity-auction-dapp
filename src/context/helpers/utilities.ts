...
export const INITIAL_STATE_TESTNET_DEFAULT = process.env.NEXT_PUBLIC_NETWORK_ID === 'testnet04' ? true : false;
export const IS_INITIALIZED = 'isInitialized'

export function getTestnetFlag(): boolean {
  if (typeof window === "undefined") return false;

  return !!INITIAL_STATE_TESTNET_DEFAULT;
}
